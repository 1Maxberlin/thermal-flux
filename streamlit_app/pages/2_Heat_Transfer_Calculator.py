...
hero(
    ...
    tagline="Two classical results, side by side: steady one-dimensional conduction "
            "through a flat wall, and transient lumped-capacitance cooling of a body "
            "in a constant ambient. Every input is described physically, with its unit.",
)
...
st.info(
    "**What this means in the field** — this is the calculation behind insulating "
    "a separator, a stock tank or a steam line. Heat lost through the wall cools "
    "the crude, and cool crude drops wax and asphaltene onto the pipe wall and "
    "thickens up so the pumps work harder.",
    icon="💡",
)
...
st.info(
    "**What this means in the field** — shut-in cool-down is a real operating "
    "risk. Once a stagnant flowline drops below the wax appearance or hydrate "
    "formation temperature, you are looking at a plug and a costly remediation job.",
    icon="💡",
)
